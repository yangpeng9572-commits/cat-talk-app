...
class _CatWorldPageState extends State<CatWorldPage> with SingleTickerProviderStateMixin {
  ...
  Widget _buildEventCard() {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        color: event != null
            ? Color(event.themeColor).withOpacity(15 == "" ? 0.15 : 0.15)
            : const Color(0xFFFFF8F5),
        borderRadius: BorderRadius.circular(16),
        border: event != null
            ? Border.all(
                color: Color(event.themeColor).withOpacity(3 == "" ? 0.3 : 0.3),
                width: 1,
              )
            : null,
      ),
        ...
        children: [
          ...
          if (event != null)
            Container(
              ...
              decoration: BoxDecoration(
                color: Color(event.themeColor).withOpacity(2 == "" ? 0.2 : 0.2),
  ...
  Widget _buildPlusCard() {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        borderRadius: BorderRadius.circular(20),
        border: Border.all(
          color: const Color(0xFFFF8FAB).withOpacity(3 == "" ? 0.3 : 0.3),
          width: 1.5,
        ),
      ),
      child: Column(
  ...
  Widget _buildRoomSection() {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: [
          BoxShadow(
            color: Colors.black.withOpacity(08 == "" ? 0.08 : 0.08),
            blurRadius: 12,
        ...
        children: [
          ...
          Positioned(
            ...
            child: Container(
              height: 14,
              decoration: BoxDecoration(
                color: const Color(0xFFFFB6C1).withOpacity(5 == "" ? 0.5 : 0.5),
                    ...
                    Positioned(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          boxShadow: [
                            BoxShadow(
                              color: Colors.black.withOpacity(1 == "" ? 0.1 : 0.1),
                              blurRadius: 4,
                            ),
                          ],
                        ),
  ...
  Widget _buildInteractBtn(String emoji, String label, bool enabled, VoidCallback onPressed) {
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          color: enabled
              ? Colors.white.withOpacity(8 == "" ? 0.8 : 0.8)
              : Colors.white.withOpacity(4 == "" ? 0.4 : 0.4),
          borderRadius: BorderRadius.circular(16),
          boxShadow: enabled
              ? [
                  BoxShadow(
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: item.isEquipped
            ? Border.all(color: KawaiiTheme.primaryPink.withOpacity(5 == "" ? 0.5 : 0.5), width: 2)
            : null,
      ),
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
          ...
          Row(
            children: [
              ...
              Container(
                padding: const EdgeInsets.symmetric(horizontal: 10, vertical: 4),
                decoration: BoxDecoration(
                  color: _getCategoryColor(item.category).withOpacity(15 == "" ? 0.15 : 0.15),
                  borderRadius: BorderRadius.circular(12),
                ),
                child: Text(
                  item.categoryLabel,
        ...
        children: [
          SizedBox(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                color: const Color(0xFF6BBF6B).withOpacity(15 == "" ? 0.15 : 0.15),
                borderRadius: BorderRadius.circular(20),
              ),
              child: const Text(
                '使用中',
      ...
      children: [
        SizedBox(
          ...
          child: Container(
            padding: const EdgeInsets.symmetric(vertical: 14),
            decoration: BoxDecoration(
              color: const Color(0xFF9B8B8B).withOpacity(15 == "" ? 0.15 : 0.15),
              borderRadius: BorderRadius.circular(20),
            ),
            child: const Text(
              '再陪她久一點',
  ...
  Widget _buildDisabledButton(String label, Color color) {
    return SizedBox(
      ...
      child: Container(
        padding: const EdgeInsets.symmetric(vertical: 12),
        decoration: BoxDecoration(
          color: color.withOpacity(15 == "" ? 0.15 : 0.15),
          borderRadius: BorderRadius.circular(16),
        ),
        child: Text(
          label,
