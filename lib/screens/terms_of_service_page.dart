...
本 App 會根據貓咪叫聲的音量、音調、長短、節奏等特徵，結合 AI 規則引擎，推測貓咪可能想要表達的情緒或需求。
...
父母或監護人應告知未成年使用者如何安全使用本 App，包括錄音功能的正確使用方式。''',
            ...
            _buildSection(
              emoji: '©️',
              title: '三、智慧財產權',
              content: '''本 App 的名稱「喵心語 Cat Talk」、標誌、所有頁面設計、圖示、按鈕圖案、資料庫結構、程式碼（以下簡稱「智慧財產」），
版權與所有權均歸屬本 App 開發團隊（以下簡稱「開發者」）所有。
...
【Google ML Kit（姿勢偵測）】
用於分析人體姿勢以提供姿勢參考功能。Google 的隱私政策適用於此服務。

【Firebase（分析與推播）】
用於匿名使用統計與推播通知。Google 的隱私政策適用於此服務。
